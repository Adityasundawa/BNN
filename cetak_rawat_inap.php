    ...
    if(empty($_SESSION['admin'])){
                ...
                echo '
                    <table class="bordered" id="tbl">
                        <tbody>
                                ...
                                <td class="tgh" id="lbr" colspan="5">SURAT REKOMENDASI RAWAT INAP
                            
                            <tr class="isi">
                              <td colspan="2">
                                     Dengan ini kami merekomendasikan agar klien dengan identitas sebagai berikut : <br/><br/>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>No. Hp &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </strong>'.$row['kode'].'<br/><br/>
            ...
            <div id="lead">
                ...
                <strong>Dokter/Konselor</strong><br/>
            </div>
        </div>
