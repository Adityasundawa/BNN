...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        if (
            ...
            $periksa_urine = implode(',', $_REQUEST['periksa_urine']);
                                        ...
                                        if (!preg_match("/^[a-zA-Z0-9.,_()%&@\/\r\n -]*$/", $kriteria_diagnosis_napza)) {
                                            ...
                                            if (!preg_match("/^[a-zA-Z0-9.,_()%&@\/\r\n -]*$/", $diagnosis_lainnya)) {
                                                ...
                                                if (!preg_match("/^[a-zA-Z0-9.,_()%&@\/\r\n -]*$/", $rencana_terapi)) {
                                                    ...
                                                    $query = mysqli_query($config, "INSERT INTO tbl_asesmen(pekerjaan_dukungan,napza,legal,keluarga_sosial,psikiatris,kriteria_diagnosis_napza,diagnosis_lainnya,rencana_terapi,resume_masalah,medis,periksa_urine,id_disposisi,id_surat,id_user)
                                        VALUES('$pekerjaan_dukungan','$napza','$legal','$keluarga_sosial','$psikiatris','$kriteria_diagnosis_napza','$diagnosis_lainnya','$resume_masalah','$rencana_terapi','$medis','$periksa_urine','$id_disposisi','$id_surat','$id_user')");
            ...
            <div class="col s12">
                <nav class="secondary-nav">
                    <div class="nav-wrapper blue-grey darken-1">
                        <ul class="left">
                            <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">description</i> FORMULIR ASESMEN WAJIB LAPOR & REHABILITASI MEDIS</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
        ...
        <div class="row jarak-form">
            ...
            <form class="col s12" method="post" action="">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s5">
                        <i class="material-icons prefix md-prefix">low_priority</i><label style="margin-top:-8px">Pemeriksaan Urine</label><br />
                        <?php
                        $query = mysqli_query($config, "SELECT * FROM tbl_kategori WHERE id_katego 
                                    IN ('73','74')");
                        ...
                        ?>
                                ...
                                <input type="checkbox" id="periksa_urine<?php echo $i; ?>" class="validate" name="periksa_urine[]" value="<?php echo $row['nama_katego']; ?>">
                                <label for="periksa_urine<?php echo $i; ?>"><?php echo $row['nama_katego']; ?></label><br />
                        <?php
                            }
                        }
                        ?>
