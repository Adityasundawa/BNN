            ...
            <div class="col m12">
                <div class="card">
                    ...
                    <div class="row jarak-card">
                        <div class="col m12">
                            <div class="card">
                                ...
                                <td width="85%">
                                    <a class="btn Large deep-orange waves-effect waves-light tooltipped" data-position="right" data-tooltip="Tombol ini akan menprint surat pernyataan rawat jalan" href="?page=tsm&act=scr&id_surat='.$id_surat.'&sub=cprj&id_surat='.$id_surat.'" target="_blank"><i class="material-icons">print</i> PRINT RAJAL</a>
                                    <a class="btn Large deep-orange waves-effect waves-light tooltipped" data-position="right" data-tooltip="Tombol ini akan menprint surat rekomendasi ke Balai Rehabilitasi untuk di rawat inap" href="?page=tsm&act=scr&id_surat='.$id_surat.'&sub=ctk&id_surat='.$id_surat.'" target="_blank">
                    ...
                    <!-- Row form END -->';
                            ...
                            echo '<tr>
                                    <td colspan="5"><center><p class="add">Tidak ada data hasil Scrinang untuk ditampilkan.</p>
                                    <a class="btn small blue waves-effect waves-light white-text" href="?page=tsm&act=scr&id_surat='.$row['id_surat'].'&sub=add_z"><b>Scrinang Sekarang</b></a></center></td>
                                  </tr>';
                            }
                 echo '</tbody>
                    </table>
...
<!-- Include JENIS ZAT AND -->

                                    <br/>
                                </div>   
                            </div>
                        </div>
                            <div id="tombol2">Formulir Assesmen Wajib Lapor
                                <div class="center">
                                    <div class="accent">
                                    <br/>
                                                           <!-- Row form Start -->
                                ...
                                <div class="card-content">
                                    <table>
                                        <thead class="blue lighten-5 blue-text">
                                            ...
                                            Data Formulir Assesmen Wajib Lapor<i class="material-icons md-36 right">call_received</i></div>
                                        </thead>';
                    ...
                    <!-- Row form END -->';
                        ...
                        echo '<tr><td colspan="5"><center><p class="add">Tidak ada data Assesmen untuk ditampilkan.</p>
                            <a class="btn small blue waves-effect waves-light white-text" href="?page=tsm&act=scr&id_surat='.$id_surat.'&sub=add_s"><b>Isi Form Sekarang</b></a></center></td></tr>';
                            }
                     '</tbody>
                    </table>
                </div>
...
?>
            <!-- Include penjadwalan keluarga AND -->
        <!-- Include penjadwalan kelompok AND -->
