                                ...
                                while($row = mysqli_fetch_array($query)){
                                  ...
                                  <tr>
                                    ...
                                    if($_SESSION['admin'] == 1 || $_SESSION['admin'] == 2){
                                        echo '  <a class="btn small deep-purple accent-4 waves-effect waves-light tooltipped" data-position="left" data-tooltip="Pilih View untuk mengelola data Klien" href="?page=tsm&act=scr&id_surat='.$row['id_surat'].'"><i class="material-icons">update</i> NEXT</a>
                                      ...
                                      echo '
                                            <a class="btn small deep-purple accent-4 waves-effect waves-light tooltipped" data-position="left" data-tooltip="Pilih View untuk mengelola data Klien" href="?page=tsm&act=scr&id_surat='.$row['id_surat'].'"><i class="material-icons">update</i> NEXT</a>';
                                    } echo '
                                        </td>
                                    </tr>';
                                }
